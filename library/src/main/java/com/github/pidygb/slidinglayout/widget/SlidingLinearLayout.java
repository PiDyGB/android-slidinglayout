...
public class SlidingLinearLayout extends LinearLayout {
    ...
    public void collapse() {
        Log.d(SlidingLinearLayout.class.getSimpleName(), "Test1: " + isObserved + " && " + !deliveryExpandOnGlobalLayoutFinished);
        Log.d(SlidingLinearLayout.class.getSimpleName(), "Test2: " + mExpandedHeight+ " && " + isAnimated);
        ...
        isAnimated = true;
        mExpanded = !mExpanded;
        Log.d(SlidingLinearLayout.class.getSimpleName(), "Expanded: " + mExpandedHeight);
